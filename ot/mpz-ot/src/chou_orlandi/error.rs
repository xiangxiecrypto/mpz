use mpz_ot_core::{chou_orlandi::msgs::Message, msgs::OTMessage};
...
impl From<enum_try_as_inner::Error<OTMessage>> for SenderError {
    fn from(value: enum_try_as_inner::Error<OTMessage>) -> Self {
...
impl From<enum_try_as_inner::Error<OTMessage>> for ReceiverError {
    fn from(value: enum_try_as_inner::Error<OTMessage>) -> Self {
